...
workflow TOMTE {
    ...
    ch_drop_mae_high_q_vcf        = params.drop_mae_high_q_vcf          ? Channel.fromPath(params.drop_mae_high_q_vcf).combine(Channel.fromPath(params.drop_mae_high_q_vcf_tbi)).collect()
