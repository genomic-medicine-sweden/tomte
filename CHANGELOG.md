...
- Added `--gencode_annotation_version`, the version of the gencode reference version to download if fasta or gtf is not provided and switch `--skip_download_vep` for the vep reference download [#144](https://github.com/genomic-medicine-sweden/tomte/pull/144)
