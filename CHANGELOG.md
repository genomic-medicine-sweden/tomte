...
- Names of other swtiches (subsample*region_switch, downsample_switch, run_drop_ae_switch and run_drop_as_switch) so that they all start with switch* (switch_subsample_region, switch_downsample, switch_drop_ae and switch_drop_as)
