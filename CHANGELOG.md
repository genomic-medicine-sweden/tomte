...
- Changed how variants are caller is added to the vcf, it is now done using the local module add_found_in_tag [#183](https://github.com/genomic-medicine-sweden/tomte/pull/183)
