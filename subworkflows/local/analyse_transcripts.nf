...
//
 ...
 include { GENERATE_CONFIG_DROP     } from '../../modules/local/generate_config_drop'
...
workflow ANALYSE_TRANSCRIPTS {
    ...
    main:
        ...
        ch_versions = ch_versions.mix(GENERATE_CONFIG_DROP.out.versions)
    ...
    emit:
        ...
        config_drop           = GENERATE_CONFIG_DROP.out.config_drop                // channel: [ path(confg_file.yml) ]
        drop_ae_out           = GENERATE_CONFIG_DROP.out.drop_ae_out
